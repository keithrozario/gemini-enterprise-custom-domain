...
The current implementation acts somewhat like a redirect, hence the user will eventuall see the `vertexaisearch` url :(. I think this is to support things like browser cookies that must respect the final domain.
